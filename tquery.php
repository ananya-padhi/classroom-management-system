...
<body background="C:\xampp\htdocs\projpic\1.jpg" style="background-attachment:fixed;" >
	...
	<ul id="ul1">
		<li id="li1"><a href="ttimetable.php">Timetable</a></li>	
		...
		<li id="li1"><a href="tquery.php">Answer query and doubts</a></li>
	...
	<?php
		...
		$result=mysqli_query($con,"select q.tid, q.question, t.id from query q, teacher t where t.id = q.tid ");
